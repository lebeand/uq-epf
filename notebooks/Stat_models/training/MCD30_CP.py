...
"""Conformal prediction post-processing for MC Dropout forecasts."""
...
pred_val_list = []
pred_test_list = list((MCD30["prediction"]-offset) / scale)
for model in MCD30["model"]:
