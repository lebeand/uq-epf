# XGBoost-QRA with rolling window  # noqa: INP001

"""Quantile regression averaging calibration for XGBoost forecast ensembles."""
...
# load model
# model_name = "XGBoost_100est_lr0.1_md5"
model_name = "XGBoost"
...
model_name = model_name.replace("XGBoost", "XGBoost_QRA")

XGBoost_model = model_dict[0]
offset = XGBoost_model["offset"]
scale = XGBoost_model["scale"]
pred_val_1461 = (XGBoost_model["prediction_val_1461"] - offset) / scale
pred_val_1092 = (XGBoost_model["prediction_val_1092"] - offset) / scale
pred_val_84 = (XGBoost_model["prediction_val_84"] - offset) / scale
pred_val_56 = (XGBoost_model["prediction_val_56"] - offset) / scale
pred_test_1461 = (XGBoost_model["prediction_1461"] - offset) / scale
pred_test_1092 = (XGBoost_model["prediction_1092"] - offset) / scale
pred_test_84 = (XGBoost_model["prediction_84"] - offset) / scale
pred_test_56 = (XGBoost_model["prediction_56"] - offset) / scale
...
XGBoost_QRA = {}
XGBoost_QRA["model_name"] = "XGBoost_QRA"
XGBoost_QRA["prediction"] = pred_test_mean
XGBoost_QRA["quantile"] = percentiles_test

model_dict = []
model_dict.append(XGBoost_QRA)
