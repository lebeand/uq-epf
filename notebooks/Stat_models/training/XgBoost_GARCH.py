# XGBoost-GARCH with rolling window  # noqa: INP001

"""GARCH-based residual volatility calibration for XGBoost forecasts."""
...
model_name = model_name.replace("XGBoost", "XGBoost_GARCH")
...
XGBoost_GARCH = {}
XGBoost_GARCH["model_name"] = "XGBoost_GARCH"
XGBoost_GARCH["prediction"] = pred_test
XGBoost_GARCH["quantile"] = percentiles_test

model_dict = []
model_dict.append(XGBoost_GARCH)
